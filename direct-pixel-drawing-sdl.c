 ...
 * =====================================================================================
 *
 *       Filename:  direct-pixel-drawing-sdl.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  12/09/2012 04:31:29 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
int main()
{
	...
	/* Attempt to set a 256x256 hicolor (16bit) video mode.
	 * This will set up some type of 16bit mode,  but we won't
	...
	/* Get a pointer into the video surfaces memory. */
	...
	/* Inform SDL the screen has been changed. This is necessary
	 * because SDL's screen surface is not always the real 
